...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .tarjeta { background: #fff; border: 1px solid #e2dacb; border-radius: 2mm;
             padding: 10mm 6mm; text-align: center; display: flex; flex-direction: column;
             align-items: center; gap: 5mm; page-break-inside: avoid; break-inside: avoid; }
  h2 { margin: 0; font-family: "Cormorant Garamond", Georgia, serif; font-weight: 500; font-size: 28pt; }
  .qr { width: 45mm; height: 45mm; }
  .qr svg { width: 100%; height: 100%; display: block; }
  .pedido { margin: 0; font-size: 11pt; letter-spacing: .01em; }
